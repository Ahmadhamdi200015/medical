        ...
        body: GetBuilder<SignupController>(
          builder: (controller) => HandlingDataView(
            ...
            widget: Container(
              ...
              child: SingleChildScrollView(child: GetBuilder<SignupController>(
                builder: (controller) {
                  return SizedBox(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          MaterialButton(
                            ...
                            onPressed:controller.selectedValue=='doctor'? () {
                          ...
                          if(controller.file!=null&&controller.selectedValue=='doctor') Image.file(width: 70,height: 70,controller.file!)
                        ],),
                        20.h,
                        DropListDown(
                          enabled: controller.selectedValue == 'doctor'
                              ? true
                              : false,
